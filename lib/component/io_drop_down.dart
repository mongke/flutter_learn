...
class IoDropDown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool hasValues =
        values.isNotEmpty &&
        !(values.length == 1 && values.first == "No group");
      ...
      child: GestureDetector(
        ...
        child: InputDecorator(
          ...
          child: Row(
            ...
            children: [
              Text(
                hasValues ? value : "No group", // Show "No group" if no values
                style: TextStyle(
                  fontSize: 16,
                  color:
                      hasValues
                          ? Colors.black
                          : Colors.grey, // Grey color for "No group"
                ),
              ),
              Icon(
                ...
                color:
                    hasValues
                        ? Colors.black
                        : Colors.grey, // Grey icon if no values
              ),
            ],
          ),
        ),
                      ...
                      return ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              isSelected
                                  ? Colors
                                      .purple // Primary button color for selected
                                  : Colors
                                      .grey[300], // Secondary button color for unselected
                          foregroundColor:
                              isSelected
                                  ? Colors
